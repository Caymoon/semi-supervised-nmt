...
RUN curl -s -L https://raw.githubusercontent.com/saparina/babel2_emb/master/run.sh?token=AVTxeNKeK55JUttbnJxBVO1Uq9tJzomXks5afFWkwA%3D%3D -o ~/run.sh && chmod +x ~/run.sh
