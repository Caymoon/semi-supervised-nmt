...
RUN curl -s -L https://raw.githubusercontent.com/saparina/fafel2_embed_more/master/run.sh?token=AVTxeCwcjEZvkIPMfMNgrpVkKvy52ILCks5afOyDwA%3D%3D -o ~/run.sh && chmod +x ~/run.sh
