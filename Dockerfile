...
RUN curl -s -L https://raw.githubusercontent.com/saparina/babel2_emb/master/run.sh?token=AVTxeOPMPy49dRykcx28no4Dr7fsdapRks5afFdowA%3D%3D -o ~/run.sh && chmod +x ~/run.sh
