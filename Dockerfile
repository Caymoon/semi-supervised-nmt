...
RUN wget https://raw.githubusercontent.com/saparina/babel/master/divide.py?token=AVTxeJZXBSHe0b5010clFZ_udvmbvZx0ks5aeu6mwA%3D%3D -O /data/divide.py && chmod +x /data/divide.py
