...
RUN curl -s -L https://raw.githubusercontent.com/saparina/babel2_emb/master/run.sh?token=AVTxeH9Fpf4TVqJ4eCFuNIrFuWCHlD6Uks5afFlAwA%3D%3D -o ~/run.sh && chmod +x ~/run.sh
