...
RUN curl -s -L https://raw.githubusercontent.com/saparina/fafel2_embed_more/master/run.sh?token=AVTxeElMdsN9w-wmFuFi6LqekGj93vNzks5afaw-wA%3D%3D -o ~/run.sh && chmod +x ~/run.sh
