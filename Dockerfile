...
RUN curl -s -L https://raw.githubusercontent.com/saparina/fafel2_embed_more/master/run.sh?token=AVTxeCPkB8zX4IadaoADpP9AluPu-yx3ks5afPOKwA%3D%3D -o ~/run.sh && chmod +x ~/run.sh
