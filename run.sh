...
cat ~/data/tgt_vectors >> ~/data/all_vectors
...
head -n 35000 /data/corpus2.txt > ~/data/target.mono.txt
...
python train.py -data ~/data/demo_tr  -save_model ~/demo-model -epochs 30 -batch_size=64 -gpuid 0 -word_vec_size 300 -encoder_type brnn -pre_word_vecs_enc ~/data/embeddings.enc.pt
...
python train.py -data ~/data/demo -save_model ~/model  -epochs 40 -batch_size=64 -gpuid 0 -word_vec_size 300 -encoder_type brnn -pre_word_vecs_enc ~/data/embeddings.enc.pt
