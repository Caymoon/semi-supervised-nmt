...
# Forward Translation
python preprocess.py -train_src ~/data/target.train.txt -train_tgt ~/data/source.train.txt -valid_src ~/data/source.valid.txt -valid_tgt ~/data/target.valid.txt -save_data ~/data/demo
...
python train.py -data ~/data/demo -save_model ~/demo-model -epochs 20 -batch_size=64 -gpuid 0
